    ...
    def synthesize_speech(self, text: str, sample_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            inputs = self.bark_processor(
                text,
                voice_preset="v2/en_speaker_3",  # Use a neutral English voice
                return_tensors="pt"
            ).to(self.device)
    ...
    def process_text_to_speech_validation(self, text: str, sample_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "processing_successful": synthesis_result["synthesis_successful"] and asr_result["recognition_successful"]
            }
