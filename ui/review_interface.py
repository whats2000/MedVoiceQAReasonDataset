                    ...
                    try:
                        ...
                        if visual_box and visual_box.get("bounding_box"):
                            ...
                            if show_bbox:
                                ...
                                st.image(image_with_bbox, caption=f"Medical Image with Bounding Box - {sample_id}", use_container_width=True)
                            else:
                        ...
                        if visual_box:
                            with st.expander("🎯 Visual Localization Details", expanded=False):
                                bbox = visual_box.get("bounding_box", {})
                                st.write("**Bounding Box Coordinates (normalized):**")
